...
\fmfset{arrow_len}{cm}\fmfset{arrow_ang}{0}
  ...
  %%% Top vertex
  \fmf{plain, label=$\widetilde{\chi}_1^-$,label.dist=+3, label.side=left}{v5,v6}
  \fmf{boson}_1^-$,label.dist=+3, label.side=left}{v5,v6}
  ...
  %%% Bottom vertex
  \fmf{plain, label=$\widetilde{\chi}_1^+$, label.dist=+3, label.side=right}{v2,v3}
  \fmf{boson}_1^+$, label.dist=+3, label.side=right}{v2,v3}
