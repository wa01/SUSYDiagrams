...
\begin{fmfgraph*}(180,90)
  ...
  \fmf{plain, label=$\widetilde{\chi}_1^+$,label.dist=+3, label.side=left}{v3,v4}
  \fmf{boson}_1^+$,label.dist=+3, label.side=left}{v3,v4}
  \fmf{plain}{v4,o4}
  \fmf{boson}{v4,o4}
  \fmf{photon}{v4,o3}
  ...
  \fmf{plain, label=$\widetilde{\chi}_1^+$,label.dist=+2, label.side=right}{v2,v5}
  \fmf{boson}_1^+$,label.dist=+2, label.side=right}{v2,v5}
  \fmf{plain}{v5,o5}
  \fmf{boson}{v5,o5}
  \fmf{photon}{v5,o6}
