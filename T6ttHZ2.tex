...
\begin{fmfgraph*}(180,90) %\fmfpen{thick}
  ...
  \fmf{dashes, label=\sTopt, label.side=left}{v1,v3}
  \fmf{dashes, label=\sToptb, label.side=right}{v1,v2}
  ...
  \fmf{dashes}{v2,o1}
  \fmflabel{\PH (\PZ)}{o1}
  \fmf{dashes, label=\sTopb, label.dist=+3, label.side=left}{v2,v4}
  \fmf{fermion}{v4,o2}
  \fmflabel{$\mathrm{\overline{\MainQuark}}$}{o2}
